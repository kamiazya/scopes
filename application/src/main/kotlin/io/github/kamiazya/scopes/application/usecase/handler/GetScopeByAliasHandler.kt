...
import io.github.kamiazya.scopes.application.usecase.query.GetScopeByAlias
...
) : UseCase<GetScopeByAlias, ScopesError, ScopeDTO> {

    override suspend operator fun invoke(input: GetScopeByAlias): Either<ScopesError, ScopeDTO> = 
        either {
            ...
            if (scopeResult == null) {
                raise(PersistenceError.DataCorruption(
