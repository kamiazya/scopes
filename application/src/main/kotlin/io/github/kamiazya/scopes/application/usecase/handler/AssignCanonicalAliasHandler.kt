...
) : UseCase<AssignCanonicalAlias, ApplicationError, ScopeAliasDTO> {

    override suspend operator fun invoke(input: AssignCanonicalAlias): Either<ApplicationError, ScopeAliasDTO> {
