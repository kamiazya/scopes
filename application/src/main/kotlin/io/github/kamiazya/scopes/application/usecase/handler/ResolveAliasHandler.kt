...
import io.github.kamiazya.scopes.application.usecase.query.ResolveAlias
...
) : UseCase<ResolveAlias, ApplicationError, ResolveAliasResult> {

    override suspend operator fun invoke(input: ResolveAlias): Either<ApplicationError, ResolveAliasResult> {
