...
class RemoveAliasHandler(
    ...
    override suspend operator fun invoke(input: RemoveAlias): Either<ApplicationError, RemoveAliasResult> {
        return transactionManager.inTransaction {
            AliasName.create(input.aliasName)
                ...
                .flatMap { aliasName ->
                    aliasManagementService.removeAlias(aliasName)
                        ...
                        .map { removed -> RemoveAliasResult(removed) }
                }
        }
    }
}