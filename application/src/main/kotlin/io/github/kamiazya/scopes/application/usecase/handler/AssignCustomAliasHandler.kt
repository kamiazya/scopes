...
) : UseCase<AssignCustomAlias, ApplicationError, ScopeAliasDTO> {

    override suspend operator fun invoke(input: AssignCustomAlias): Either<ApplicationError, ScopeAliasDTO> {
