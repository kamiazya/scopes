...
class CreateScopeHandlerPropertyTest :
    StringSpec({
...
private class TestTransactionManager : TransactionManager {
    override suspend fun <E, T> inTransaction(block: suspend TransactionContext.() -> Either<E, T>): Either<E, T> = TestTransactionContext().block()
