...
class SwitchContextHandlerTest : StringSpec({
    ...
    "should switch to a valid context successfully" {
        ...
        val expectedContextView = ContextView(
            ...
            key = ContextViewKey.create("my-context").getOrElse { throw AssertionError("Failed to create value object") },
            name = ContextViewName.create("MyContext").getOrElse { throw AssertionError("Failed to create value object") },
    ...
    "should preserve all context properties when switching" {
        ...
        val contextView = ContextView(
            ...
            filter = ContextViewFilter.create("type:bug AND priority:high").getOrElse { throw AssertionError("Failed to create value object") },
    ...
    "should handle context without description" {
        ...
        val contextView = ContextView(
            id = ContextViewId.generate(),
            key = ContextViewKey.create("simple-context").getOrElse { throw AssertionError("Failed to create value object") },
            name = ContextViewName.create("SimpleContext").getOrElse { throw AssertionError("Failed to create value object") },
