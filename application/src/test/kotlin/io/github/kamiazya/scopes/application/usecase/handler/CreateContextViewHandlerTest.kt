...
class CreateContextViewHandlerTest :
    StringSpec({
        ...
        "should create a context view successfully with valid input" {
            ...
            val expectedContextView = ContextView(
                ...
                key = ContextViewKey.create("my-context").getOrElse {
                    throw AssertionError("Failed to create ContextViewKey")
                },
                name = ContextViewName.create("MyContext").getOrElse {
                    throw AssertionError("Failed to create ContextViewName")
                },
                filter = ContextViewFilter.create("status:active").getOrElse {
                    throw AssertionError("Failed to create ContextViewFilter")
                },
        ...
        "should create a context view without description" {
            ...
            val expectedContextView = ContextView(
                ...
                filter = ContextViewFilter.create("type:task").getOrElse {
                    throw AssertionError("Failed to create ContextViewFilter")
                },
                description = null,
                createdAt = timestamp,
        ...
        "should handle very long valid names" {
            ...
            val expectedContextView = ContextView(
                id = ContextViewId.generate(),
                key = ContextViewKey.create("long-name-context").getOrElse {
                    throw AssertionError("Failed to create ContextViewKey")
                },
                name = ContextViewName.create(longName).getOrElse {
                    throw AssertionError("Failed to create ContextViewName")
                },
                filter = ContextViewFilter.create("status:active").getOrElse {
                    throw AssertionError("Failed to create ContextViewFilter")
        ...
        "should handle complex filter expressions" {
            ...
            val expectedContextView = ContextView(
                id = ContextViewId.generate(),
                key = ContextViewKey.create("complex-filter").getOrElse {
                    throw AssertionError("Failed to create ContextViewKey")
                },
                name = ContextViewName.create("ComplexFilter").getOrElse {
                    throw AssertionError("Failed to create ContextViewName")
                },
                filter = ContextViewFilter.create(complexFilter).getOrElse {
                    throw AssertionError("Failed to create ContextViewFilter")
                },
