...
class ListContextViewsHandlerTest : StringSpec({
    ...
    "should list all context views without active context when includeInactive is false" {
        ...
        val contextViews = listOf(
            ContextView(
                ...
                key = ContextViewKey.create("context-1").getOrElse { throw AssertionError("Failed to create value object") },
                name = ContextViewName.create("Context1").getOrElse { throw AssertionError("Failed to create value object") },
                filter = ContextViewFilter.create("status:open").getOrElse { throw AssertionError("Failed to create value object") },
                description = null,
                createdAt = timestamp,
                updatedAt = timestamp
            ),
            ContextView(
                id = ContextViewId.generate(),
                key = ContextViewKey.create("context-2").getOrElse { throw AssertionError("Failed to create value object") },
                name = ContextViewName.create("Context2").getOrElse { throw AssertionError("Failed to create value object") },
                filter = ContextViewFilter.create("type:bug").getOrElse { throw AssertionError("Failed to create value object") },
    ...
    "should include active context information when includeInactive is true" {
        ...
        val contextViews = listOf(
            ...
            ContextView(
                id = ContextViewId.generate(),
                key = ContextViewKey.create("inactive-context").getOrElse { throw AssertionError("Failed to create value object") },
                name = ContextViewName.create("InactiveContext").getOrElse { throw AssertionError("Failed to create value object") },
                filter = ContextViewFilter.create("status:done").getOrElse { throw AssertionError("Failed to create value object") },
                description = null,
                createdAt = timestamp,
                updatedAt = timestamp
            )
    ...
    "should properly map context view properties" {
        ...
        val contextView = ContextView(
            id = contextId,
            key = ContextViewKey.create("detailed-context").getOrElse { throw AssertionError("Failed to create value object") },
            name = ContextViewName.create("DetailedContext").getOrElse { throw AssertionError("Failed to create value object") },
            filter = ContextViewFilter.create("type:task AND priority:high").getOrElse { throw AssertionError("Failed to create value object") },
    ...
    "should handle mixed contexts with and without descriptions" {
        ...
        val contextViews = listOf(
            ContextView(
                id = ContextViewId.generate(),
                key = ContextViewKey.create("with-desc").getOrElse { throw AssertionError("Failed to create value object") },
                name = ContextViewName.create("WithDescription").getOrElse { throw AssertionError("Failed to create value object") },
                filter = ContextViewFilter.create("status:open").getOrElse { throw AssertionError("Failed to create value object") },
            ...
            ContextView(
                id = ContextViewId.generate(),
                key = ContextViewKey.create("without-desc").getOrElse { throw AssertionError("Failed to create value object") },
                name = ContextViewName.create("WithoutDescription").getOrElse { throw AssertionError("Failed to create value object") },
                filter = ContextViewFilter.create("type:bug").getOrElse { throw AssertionError("Failed to create value object") },
                description = null,
                createdAt = timestamp,
                updatedAt = timestamp
