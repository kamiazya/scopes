 ...
 */
class DddBoundariesTest : StringSpec({
            ...
            Konsist
                ...
                .assertFalse { domainClass ->
                    ...
                    domainClass.annotations.any { annotation ->
                        annotation.name.contains("Entity") || // JPA
                        annotation.name.contains("Table") ||
                        annotation.name.contains("Column") ||
                        annotation.name.contains("Serializable") || // Kotlinx serialization
                        annotation.name.contains("Component") || // DI
                ...
                .assertFalse { aggregate ->
                    aggregate.properties().any { prop ->
                        ...
                        boundedContexts.any { ctx ->
                            ...
                            !type.contains("Id") &&
                            !type.contains("List<") && // Collections of IDs are OK
                            !type.contains("Set<")
                        }
                    }
                }
            ...
            Konsist
                ...
                .assertFalse { useCase ->
                    ...
                    useCase.properties().any { prop ->
                        prop.type.sourceType.endsWith("UseCase") ||
                        prop.type.sourceType.endsWith("Handler")
                    }
                }
        }
    }
