 ...
 */
class ErrorHierarchyValidationTest :
    StringSpec({
        ...
        "error classes should provide context" {
            boundedContexts.forEach { context ->
                Konsist
                    ...
                    .filter { !it.name.endsWith("Test") } // Include only non-test error classes
                    .assertTrue { error ->
                ...
                Konsist
                    ...
                    .assertTrue { validationError ->
                        ...
                        validationError.properties().any { prop ->
                            ...
                            true // Simple singleton errors are OK
                    }
            }
        }
            ...
            boundedContexts.forEach { context ->
                Konsist
                    ...
                    .assertFalse { handler ->
                        ...
                        handler.text.contains("mapLeft { _ ->") ||
                ...
                Konsist
                    ...
                    .assertTrue { errorClass ->
                        ...
                        errorClass.properties()
                            .filter { it.type?.sourceType?.equals("String") == true }
                            .all { prop ->
                                prop.name != "s" &&
                                    prop.name != "str" &&
                                    prop.name != "msg" &&
