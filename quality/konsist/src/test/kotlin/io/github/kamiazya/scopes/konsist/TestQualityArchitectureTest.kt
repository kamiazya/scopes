...
class TestQualityArchitectureTest :
    DescribeSpec({
        describe("Test Quality Architecture Rules") {
            ...
            it("repository tests should properly manage database resources") {
                Konsist
                    .scopeFromProject()
                    .files
                    .flatMap { it.classes() }
            ...
            it("tests should assert specific error types not just isLeft") {
                Konsist
                    .scopeFromProject()
                    .files
                    .withNameEndingWith("Test.kt")
                    .flatMap { it.functions() }
                    .filter { function ->
                        function.annotations.any { it.name == "Test" } ||
            ...
            it("SqlDelight repository tests should use in-memory databases") {
                Konsist
                    .scopeFromProject()
                    .files
                    .flatMap { it.classes() }
            ...
            it("tests should not use Thread.sleep for timing") {
                Konsist
                    .scopeFromProject()
                    .files
                    .withNameEndingWith("Test.kt")
            ...
            it("test functions should have descriptive names") {
                Konsist
                    .scopeFromProject()
                    .files
                    .flatMap { it.classes() }
            ...
            it("repository tests should test error scenarios") {
                Konsist
                    .scopeFromProject()
                    .files
                    .flatMap { it.classes() }
            ...
            it("tests should handle nullable types with safe calls") {
                Konsist
                    .scopeFromProject()
                    .files
                    .withNameEndingWith("Test.kt")
