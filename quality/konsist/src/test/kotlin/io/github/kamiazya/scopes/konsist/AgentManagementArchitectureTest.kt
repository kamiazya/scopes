 ...
 */
class AgentManagementArchitectureTest : StringSpec({
            ...
            .assertTrue { handler ->
                ...
                handler.functions().any { func ->
                    func.parameters.any { param ->
                        param.type.sourceType.contains(expectedCommandOrQuery)
                    }
                }
            }
    }
        ...
        Konsist
            ...
            .assertTrue { repository ->
                repository.functions().all { function ->
                    ...
                    function.name == "toString" || // Object methods
        ...
        Konsist
            ...
            .assertTrue { entity ->
                ...
                entity.functions().any { func ->
                    ...
                    !func.name.startsWith("component") && // Data class methods
                    func.name != "copy" &&
                    func.name != "toString" &&
                    func.name != "equals" &&
                    func.name != "hashCode"
