 ...
 */
class CoroutineTestingRulesTest : DescribeSpec({
        ...
        it("suspend function tests should be properly structured") {
            Konsist.scopeFromTest()
                ...
                .assertTrue { function ->
                    ...
                    function.hasAnnotation("Test") // JUnit might handle it
                }
        }
        ...
        it("coroutine exception handling should be tested") {
            Konsist.scopeFromTest()
                ...
                .assertTrue { testClass ->
                    ...
                    val isExempt = testClass.hasAnnotation("NoExceptionTestRequired")
