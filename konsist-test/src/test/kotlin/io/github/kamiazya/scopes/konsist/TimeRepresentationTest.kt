 ...
 */
class TimeRepresentationTest : DescribeSpec({
            ...
            Konsist
                ...
                .assertTrue { property ->
                    ...
                    if (isDurationRelated) {
                        ...
                        typeName == "Duration" || typeName == "Duration?" ||
                        // Allow these for backwards compatibility or special cases
                        typeName == "Int" || typeName == "Int?" || // For simple counts
            ...
            Konsist
                ...
                .assertTrue { property ->
                    ...
                    if (isTimestampRelated) {
                        val typeName = property.type?.name
                        typeName == "Instant" || typeName == "Instant?" ||
                        property.hasAnnotation { it.name == "Deprecated" }
                    } else {
                        true
                    }
