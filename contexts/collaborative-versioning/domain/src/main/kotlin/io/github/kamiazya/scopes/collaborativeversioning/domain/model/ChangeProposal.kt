...
data class ChangeProposal private constructor(
     ...
     */
    fun addProposedChange(proposedChange: ProposedChange, timestamp: Instant = SystemTimeProvider().now()): Either<ChangeProposalError, ChangeProposal> =
        either {
     ...
     */
    fun removeProposedChange(proposedChangeId: String, timestamp: Instant = SystemTimeProvider().now()): Either<ChangeProposalError, ChangeProposal> = either {
        ensure(state.isEditable()) {
     ...
     */
    fun submit(timestamp: Instant = SystemTimeProvider().now()): Either<ChangeProposalError, ChangeProposal> = either {
     ...
     */
    fun startReview(timestamp: Instant = SystemTimeProvider().now()): Either<ChangeProposalError, ChangeProposal> = either {
     ...
     */
    fun addReviewComment(comment: ReviewComment, timestamp: Instant = SystemTimeProvider().now()): Either<ChangeProposalError, ChangeProposal> = either {
     ...
     */
    fun approve(approver: Author, message: String? = null, timestamp: Instant = SystemTimeProvider().now()): Either<ChangeProposalError, ChangeProposal> =
        either {
     ...
     */
    fun reject(reviewer: Author, reason: String, timestamp: Instant = SystemTimeProvider().now()): Either<ChangeProposalError, ChangeProposal> = either {
     ...
     */
    fun apply(timestamp: Instant = SystemTimeProvider().now()): Either<ChangeProposalError, Pair<ChangeProposal, AppliedChanges>> = either {
     ...
     */
    fun detectConflicts(currentResourceState: ResourceState): List<ProposalConflict> {
        val conflicts = mutableListOf<ProposalConflict>()
     ...
     */
    fun resolveComment(commentId: String, resolver: Author, timestamp: Instant = SystemTimeProvider().now()): Either<ChangeProposalError, ChangeProposal> =
        either {
