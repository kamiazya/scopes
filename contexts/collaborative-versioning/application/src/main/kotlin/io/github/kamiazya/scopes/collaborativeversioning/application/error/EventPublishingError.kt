...
sealed class EventPublishingError : ApplicationError() {
     ...
     */
    data class StorageFailed(val eventId: EventId, val eventType: String, val reason: String, val cause: Throwable? = null) : EventPublishingError()
     ...
     */
    data class InfrastructureError(val message: String, val cause: Throwable? = null) : EventPublishingError()
}
