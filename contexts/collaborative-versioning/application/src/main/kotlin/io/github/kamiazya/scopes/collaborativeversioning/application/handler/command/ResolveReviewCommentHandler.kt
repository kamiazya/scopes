...
class ResolveReviewCommentHandler(private val changeProposalRepository: ChangeProposalRepository) :
    CommandHandler<ResolveCommentCommand, ReviewProposalError, ReviewProposalResultDto> {

    override suspend fun invoke(input: ResolveCommentCommand): Either<ReviewProposalError, ReviewProposalResultDto> = either {
        ...
        val proposalWithResolvedComment = proposal.resolveComment(input.commentId, input.resolver, timestamp)
            .fold(
