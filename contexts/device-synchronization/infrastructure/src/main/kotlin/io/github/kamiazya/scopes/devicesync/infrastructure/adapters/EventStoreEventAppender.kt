 ...
 * concrete event store contract implementation.
 */
class EventStoreEventAppender(private val eventStoreQueryPort: EventStoreQueryPort, private val logger: Logger, private val json: Json) : EventAppender {
