...
sealed class UserPreferencesIntegrationError : ScopesError() {
     ...
     */
    data class PreferencesServiceUnavailable(val retryAfter: Duration? = null) : UserPreferencesIntegrationError()
     ...
     */
    data class MalformedPreferencesResponse(val expectedFormat: String, val actualContent: String? = null) : UserPreferencesIntegrationError()

    /**
     * Error when preferences service request times out.
     */
    data class PreferencesRequestTimeout(val timeout: Duration) : UserPreferencesIntegrationError()
}
