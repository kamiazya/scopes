 ...
 */
class ScopeUniquenessValidationService(
     ...
     */
    suspend fun validateCrossContextUniqueness(
        title: String,
     ...
     * @return Either a domain error or Unit on success
     */
    suspend fun validateTitleUniquenessInContext(
        title: String,
        parentId: ScopeId?,
        excludeId: ScopeId? = null
    ): Either<ContextError, Unit> = either {
     ...
     * @return Either a domain error or Unit on success
     */
    suspend fun validateGlobalUniqueness(
        title: String,
        excludeId: ScopeId? = null
    ): Either<ContextError, Unit> = either {
