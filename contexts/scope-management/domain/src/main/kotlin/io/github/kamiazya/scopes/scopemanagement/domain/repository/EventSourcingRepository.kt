...
interface EventSourcingRepository<T> {
     ...
     * @return Either an error or the list of events
     */
    suspend fun getEventsBetweenVersions(aggregateId: AggregateId, fromVersion: Int, toVersion: Int): Either<ScopesError, List<DomainEvent>>
     ...
     * @return Either an error or the list of events
     */
    suspend fun getEventsByType(eventType: String, limit: Int = 100, offset: Int = 0): Either<ScopesError, List<DomainEvent>>
     ...
     * @return Either an error or the list of events
     */
    suspend fun getEventsByTimeRange(from: Instant, to: Instant, limit: Int = 100, offset: Int = 0): Either<ScopesError, List<DomainEvent>>
