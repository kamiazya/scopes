...
class DefineAspectUseCase(private val aspectDefinitionRepository: AspectDefinitionRepository, private val transactionManager: TransactionManager) {
    suspend fun execute(key: String, description: String, type: AspectType): Either<ScopesError, AspectDefinition> = transactionManager.inTransaction {
        either {
            ...
            val aspectDefinition = when (type) {
