...
) : QueryHandler<ListContextViews, ScopeManagementApplicationError, List<ContextViewDto>> {

    override suspend operator fun invoke(query: ListContextViews): Either<ScopeManagementApplicationError, List<ContextViewDto>> =
